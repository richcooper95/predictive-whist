"""
Django settings for predictive_whist project.
...
if IS_HEROKU_APP:
    ...
    # Use Sentry in production only. It's not configured for local development.
    sentry_sdk.init(
...
ROOT_URLCONF = "predictive_whist.urls"
...
WSGI_APPLICATION = "predictive_whist.wsgi.application"
