    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trump_suit', models.CharField(choices=[('H', 'Hearts'), ('S', 'Spades'), ('D', 'Diamonds'), ('C', 'Clubs'), ('N', 'No Trumps')], default='H', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inserted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('game_player_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='games.gameplayer')),
                ('game_round_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='games.gameround')),
            ],
        ),
        migrations.AddField(
